//
//  RegistrationItemShared.swift
//
//
//  Created by Ondřej Veselý on 17.09.2021.
//

public struct RegistrationItemShared<Service, Argument>: RegistrationItemProtocol {
    // MARK: - Properties
    ...
    public var registrations: [RegistrationProtocol] {
        let registration = Registration<Service, Argument>(.shared, factory)
        return [registration]
    }
